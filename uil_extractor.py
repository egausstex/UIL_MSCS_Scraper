...
class UILExtractor:
    ...
    def extract_individual_results(self):
        ...
        try:
            ...
            # TODO Decide on consistent naming for parameters in all modules.
            print(
                f"No table found for {self.scraper.year, self.scraper.conference, self.scraper.event, self.scraper.meet_level, self.scraper.level_num}"
            )
